...
const storyBody = `${pageHead("Our Story", "Built by Locals, for Locals", "A family-run, firehouse-themed car wash proud to call Leamington, Lakeshore &amp; Belle River home.")}
    <section class="story blk">
      <div class="wrap story-wrap">
        ...
        <div class="story-body">
          ...
          <p style="color:var(--steel);font-size:14px;margin-top:6px"><em>This is placeholder copy — send me your real story and I'll drop it in.</em></p>
        </div>
      </div>
    </section>
    ...
    <section class="team blk" style="background:var(--smoke)">
      <div class="wrap">
        ...
        <p class="offer-note" style="max-width:640px;margin:26px auto 0">Team details are placeholders — tell me the real names, roles, and photos and I'll add them.</p>
      </div>
    </section>`;
